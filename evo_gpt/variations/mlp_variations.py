...
class EdgeASICMLP(nn.Module):
    def __init__(self, config):
        ...
        if config.l2_norm_mlp_up:
            print("Warning: EdgeASICMLP does not support l2_norm_mlp_up.")
        if config.l2_norm_mlp_down:
            print("Warning: EdgeASICMLP does not support l2_norm_mlp_down.")
