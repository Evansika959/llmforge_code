...
def edge_asic_forward(block, x: torch.Tensor, iter_num: int) -> torch.Tensor:
...
normalization_setup_variations = {
    ...
    "edge_asic": _setup_norms_sequential,
}
...
resid_scaler_setup_variations = {
    ...
    "edge_asic": _setup_resid_scalers_sequential,
}
