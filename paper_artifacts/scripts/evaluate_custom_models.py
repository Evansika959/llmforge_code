...
# Locate the llmforge_train package root (containing model.py). Allow override via env var,
# else walk upward from this file until we find model.py — works whether the script
# is run from its in-repo location or from the paper_artifacts/ bundle.
